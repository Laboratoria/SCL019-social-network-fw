# Rehaciendo tu red social usando librerías y/o frameworks
...
[React](https://es.reactjs.org/), es una _librerías_ de JavaScript más utilizados por
...
Este proyecto se debe "resolver" en forma individual.

Para comenzar tendrás que hacer un _fork_ y _clonar_ este repositorio.

## 5. Criterios de aceptación mínimos del proyecto

Ver [03-social-network](https://github.com/Laboratoria/SCL019-social-network).

## 6. Hacker edition

Ver [03-social-network](https://github.com/Laboratoria/SCL019-social-network#6-hacker-edition).
